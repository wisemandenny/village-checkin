...
create table villagers (
  ...
  -- Selfie taken at first registration: public URL of a JPEG uploaded to
  -- Cloudflare R2, shown on the "who's here" board. NULL until taken; falls back
  -- to the fusion avatar.
  selfie_url text,
