...
| `NEXT_PUBLIC_BASE_URL` | Public URL of the web app (production: `https://app.takesavillage.com`) |
...
1. In Kit, create an **app** with OAuth enabled (Developer / App Store → Build →
   ...
   `https://app.takesavillage.com/api/kit/oauth/callback` (keep
...
3. Visit `https://app.takesavillage.com/api/kit/oauth/start?secret=YOUR_SETUP_SECRET`
